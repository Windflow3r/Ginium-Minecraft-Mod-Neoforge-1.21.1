...
public class GiniumCreativeModeTabs {
    ...
    //Ginium Items Creative Mode Tab
    public static final Supplier<CreativeModeTab> GINIUM_ITEMS_TAB = CREATIVE_MODE_TAB.register("ginium_items_tabs",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack((ItemLike) GiniumItems.GIN_APPLE.get()))
                    .title(Component.translatable("Ginium Items"))
                    .displayItems((itemDisplayParameters, outout) -> {
                        ...
                        outout.accept(GiniumItems.IMBRIUM_NUGGET);
    ...
    //Ginium Blocks Creative Mode Tab
    public static final Supplier<CreativeModeTab> GINIUM_BLOCKS_TAB = CREATIVE_MODE_TAB.register("ginium_blocks_tabs",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack((ItemLike) GiniumBlocks.GINIUM_ORE.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(Ginium.MOD_ID, "ginium_items_tab"))
                    .title(Component.translatable("Ginium Blocks"))
                    .displayItems((itemDisplayParameters, outout) -> {
                        ...
                        //Misc
                        outout.accept(GiniumBlocks.POWDERIZER);
